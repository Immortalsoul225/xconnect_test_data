...
if __name__ == "__main__":
    ...
    teachers = {
        ...
        "English": ["Teacher C", "Teacher D"],
        "Physics": ["Teacher E", "Teacher F"],
        "Chemistry": ["Teacher G", "Teacher H"],
        "Biology": ["Teacher I", "Teacher J"],
        "History": ["Teacher K", "Teacher L"],
        "Geography": ["Teacher M", "Teacher N"],
        "Computer Science": ["Teacher O", "Teacher P"],
        "Economics": ["Teacher Q", "Teacher R"],
        "Psychology": ["Teacher S", "Teacher T"],
        "Sociology": ["Teacher U", "Teacher V"],
        "Physical Education": ["Teacher W", "Teacher X"]
    }
